...
Raw swarm output: three decorrelated reviewers (Kimi K3, GLM 5.3 Flash, Qwen 3.8) via swarm-factory `plan` mode; the raw output was not retained. Every swarm claim below was checked against #217's source where checkable; verdicts are marked **confirmed**, **refuted**, or **design call**.
